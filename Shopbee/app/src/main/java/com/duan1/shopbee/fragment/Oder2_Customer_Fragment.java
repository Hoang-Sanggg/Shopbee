...
import com.duan1.shopbee.adapter.Order2_Adapter;
import com.duan1.shopbee.adapter.Order2_Customer_Adapter;
 ...
 * Use the {@link Oder2_Customer_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Oder2_Customer_Fragment extends Fragment implements ClickToOrder, ClickNextStatus{
    ...
    private Order2_Customer_Adapter orderAdapter;


    public Oder2_Customer_Fragment() {
    ...
    public static Oder2_Customer_Fragment newInstance(String param1, String param2) {
        Oder2_Customer_Fragment fragment = new Oder2_Customer_Fragment();
    ...
    private void readData() {
        ...
        orderAdapter = new Order2_Customer_Adapter(orderList, getContext(), Oder2_Customer_Fragment.this, Oder2_Customer_Fragment.this);
    }
