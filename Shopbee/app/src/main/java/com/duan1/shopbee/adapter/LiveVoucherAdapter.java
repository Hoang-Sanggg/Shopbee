...
public class LiveVoucherAdapter extends RecyclerView.Adapter<LiveVoucherAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public LiveVoucherAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_livefragment_voucher,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LiveVoucherAdapter.ViewHolder holder, int position) {
