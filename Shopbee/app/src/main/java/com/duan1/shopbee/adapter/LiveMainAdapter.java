...
public class LiveMainAdapter extends RecyclerView.Adapter<LiveMainAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.UserName.setTag(liveMainList.get(position).getUserName());
        holder.Descriprion.setTag(liveMainList.get(position).getDescription());
    }
