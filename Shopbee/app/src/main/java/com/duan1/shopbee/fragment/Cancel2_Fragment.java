...
import com.duan1.shopbee.adapter.CancelCustomer_Adapter;
import com.duan1.shopbee.adapter.CancelSeller_Adapter;
 ...
 * Use the {@link Cancel2_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Cancel2_Fragment extends Fragment implements ClickToOrder, ClickNextStatus {
    ...
    private CancelSeller_Adapter orderAdapter;

    public Cancel2_Fragment() {
     ...
     * @return A new instance of fragment Oder1_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Oder1_Customer_Fragment newInstance(String param1, String param2) {
        Oder1_Customer_Fragment fragment = new Oder1_Customer_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_oder1_, container, false);
    }
    ...
    private void readData(){
        ...
        orderAdapter = new CancelSeller_Adapter(orderList, getContext(), Cancel2_Fragment.this, Cancel2_Fragment.this);
    }

    private void data(View view){

        try {
            orderRecycer = view.findViewById(R.id.rcvTrans1);
